...
export const projects: Project[] = [
  {
    ...
    points: [
      'Technologies: TypeScript, React, React Query, MaterialUI, Express, MongoDB, Mongoose, Jest, React Testing Library, Vitest, Git, Jira',
  ...
  },
  {
    ...
    points: [
      'Technologies: TypeScript, Angular 2+, RxJS, SCSS, Express, Jasmine, Karma, Cypress, proprietary VW frameworks, Git, Jira',
  ...
  },
  {
    ...
    points: [
      'Front-end: Vue, Preact, Tailwind CSS, Shadcn, Redux Toolkit, NgRx',
      'Back-end & DB: NestJS, Fastify, PostgreSQL, Prisma',
